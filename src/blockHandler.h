...
namespace Utils
{
	...
	{
		int sub_140BEEE70(void* manager, RE::BSSoundHandle* a2, int a3, int a4)
		{
		...
		void sub_140BEDB10(RE::BSSoundHandle* a1, RE::NiAVObject* source_node)
		{
		...
		char __fastcall sub_140BED530(RE::BSSoundHandle* a1)
		{
